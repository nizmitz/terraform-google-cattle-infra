...
| ---- | ----------- | ---- | ------- | :------: |
| <a name="input_artifact_registry_configuration"></a> [artifact\_registry\_configuration](#input\_artifact\_registry\_configuration) | Specification that will be used for artifact registry | <pre>list(object({<br/>    name        = string<br/>    description = string<br/>    format      = optional(string, "DOCKER")<br/>    docker_config = optional(list(object({<br/>      immutable_tags = bool<br/>    })), [])<br/>    vulnerability_scanning_config = optional(object({<br/>      enablement_config = optional(string, "INHERITED")<br/>    }), null)<br/>  }))</pre> | `[]` | no |
...
| <a name="input_firewall_rules"></a> [firewall\_rules](#input\_firewall\_rules) | Specification that will be used for firewall rules | <pre>list(object({<br/>    name          = string<br/>    description   = optional(string)<br/>    source_ranges = list(string)<br/>    target_tags   = list(string)<br/>    allow         = optional(list(string), null)<br/>    protocol      = optional(string, "tcp")<br/>  }))</pre> | `[]` | no |
...
| Name | Description |
| ---- | ----------- |
| <a name="output_dns_private_zone_recordset_keys"></a> [dns\_private\_zone\_recordset\_keys](#output\_dns\_private\_zone\_recordset\_keys) | n/a |
